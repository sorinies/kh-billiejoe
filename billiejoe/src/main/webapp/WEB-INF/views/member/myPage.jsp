		...
		<div class="row">
			...
			<div class="col-md-9">
				...
				<div class="listForm">
					...
					<a href="${contextPath}/member/updateMyPage" id="updateDetail"
						class="btn btn-primary">내 정보 수정하기</a>
				...
				<div class="card mb-3 place">
					<div class="row g-0">
						<div class="place-thumb col-md-4"
							style="background-image:url(${latestPlace.atList[0].filePath }${latestPlace.atList[0].fileName })"></div>
						<div class="col-md-8">
							<div class="card-body">
								<h3 class="card-title">
							...
							<div class="card-footer">
								<ul class="list-inline place-info">
									...
									<li class="list-inline-item"><i
										class="bi bi-chat-square-text"></i> ${latestPlace.reviewCount}</li>
									<li class="list-inline-item"><i class="bi bi-heart-fill"></i>
										${latestPlace.likeCount }</li>
								</ul>
							</div>
						</div>
					</div>
