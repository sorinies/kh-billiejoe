				...
				<div class="listForm">
					<a href="${myReserv.placeNo}/reservationView?reserveNo=${myReserv.reserveNo }">
						...
						<div class="listForm-area2">
							...
							<p>
								(<fmt:formatDate value="${myReserv.reserveDate}" pattern="E" /> 요일) ${myReserv.useStart}:00 ~ ${myReserv.useEnd }:00
							</p>
					...
					<div class="listForm-area3">
						...
						<c:if test="${myReserv.stateNo == 3 }">
							<div class="text-end">
								<a href="${contextPath}/review/insertReview?placeNo=${myReserv.placeNo }" class="reviewA">이용후기 작성하러 가기</a>
							</div>
						</c:if>
