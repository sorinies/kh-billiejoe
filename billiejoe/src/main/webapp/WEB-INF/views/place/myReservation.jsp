		...
		<div class="row">
			...
			<div class="col-md-9" id="col-md-9">
				...
				<c:forEach items="${reservationList}" var="myReserv">
					<a
						href="${myReserv.placeNo}/reservationView?reserveNo=${myReserv.reserveNo }">
						<div class="listForm">
							<div class="listForm-area1">
								<div id="placeImg-area">

									<img
										src="${myReserv.atList[0].filePath }${myReserv.atList[0].fileName }"
										id="placeImg" name="placeImg">
							...
							<div class="listForm-area2">
								...
								(
								<fmt:formatDate pattern="MM월 dd일"
									value="${myReserv.reserveDate}" />
								)
								<p>
									(
									<fmt:formatDate value="${myReserv.reserveDate}" pattern="E" />
									요일) ${myReserv.useStart}:00 ~ ${myReserv.useEnd }:00
								</p>
								<h6>${myReserv.placeName}</h6>
								<h4>
									\
									<fmt:formatNumber value="${myReserv.placeCharge }"
										pattern="#,###" />
								</h4>
							</div>
							</a>
							...
							<div class="listForm-area3">
								...
								<c:if test="${myReserv.stateNo == 3 }">
									<div class="text-end">
										<a
											href="${contextPath}/review/insertReview?placeNo=${myReserv.placeNo }"
											class="reviewA">이용후기 작성하러 가기</a>
									</div>
								</c:if>
