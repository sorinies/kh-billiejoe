...
<jsp:include page="../common/header.jsp"></jsp:include>
  <div class="container py-5">
    <div class="content-header row">
      <h2 class="col">내가 등록한 장소</h2>
      <c:if test="${!empty loginMember }">
      <div class="col text-end">
        <a href="${contextPath}/place/addPlace" class="btn btn-primary">장소 등록</a>
      </div>
      </c:if>
    </div>
    <div class="row">
...
<%--         <form action="${contextPath}/place/list" method="get" class="row mb-3">
        ...
        <div class="card mb-3 place">
          <div class="row g-0">
            ...
            <div class="col-md-8">
              <div class="card-body">
                <h3 class="card-title"><a href="${contextPath}/place/${place.placeNo}/view?cp=${pagination.currentPage}" class="stretched-link">${place.placeName}</a></h3>
